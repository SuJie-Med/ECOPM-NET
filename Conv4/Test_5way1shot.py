...
parser.add_argument('--dataset_dir', default='/media/xqy/TOSHIBA EXT/xqy/Data/miniImageNet', help='the path of the data')
...
parser.add_argument('--outf', default='./results/1CovaMNet')
