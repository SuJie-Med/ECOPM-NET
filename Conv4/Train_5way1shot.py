...
parser.add_argument('--dataset_dir', default='/media/xqy/TOSHIBA EXT/xqy/Data/miniImageNet', help='/media/xqy/TOSHIBA EXT/xqy/Data/miniImageNet/')
...
parser.add_argument('--outf', default='./results/2CovaMNet')
...
parser.add_argument('--episode_val_num', type=int, default=10000, help='the total number of evaluation episodes')
...
# ======================================== Settings of path ============================================
# saving path
opt.outf = opt.outf+'_'+opt.data_name+'_'+str(opt.basemodel)+'_'+str(opt.way_num)+'Way_'+str(opt.shot_num)+'Shot'
